<p><?php
	esc_html_e( 'Would you like to boost your website sharing abilities?', 'upprev ' );
?></p>
<p>
<?php
printf(
	esc_html__( 'Don\'t wait, install plugin %s!', 'upprev' ),
	sprintf(
...
"><?php echo esc_html( __( 'Install', 'upprev' ) ); ?></a></p>
